(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
    typeof define === 'function' && define.amd ? define(['exports'], factory) :
      (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.anCti = {}));
  ...
  ***************************************************************************** */
  ...
  class EventEmitter {
    ...
    notify(eventName, data = {}) {
      ...
      while (emitter && !event.defaultPrevented) {
        (_a = emitter.listeners[eventName]) === null || _a === void 0 ? void 0 : _a.forEach(listener => listener(event));
  ...
  class Call {
    ...
    processEvent(name, content) {
      ...
      switch (name) {
        case 'OriginatedEvent':
          ...
          break;
        case 'DeliveredEvent':
          if ((content === null || content === void 0 ? void 0 : content.localConnectionInfo) == "alerting") {
        ...
        case 'TransferredEvent': {
          ...
          if (content.transferredConnections) {
            for (let e of content.transferredConnections) {
              if (((_a = e.connectionListItem.newConnection) === null || _a === void 0 ? void 0 : _a.callID) && e.connectionListItem.oldConnection) {
      ...
      if ((_b = content.lastRedirectionDevice) === null || _b === void 0 ? void 0 : _b.numberDialed) {
    ...
    processSnapshotDevice(snapshotDeviceResponseInfo) {
      var _a, _b;
      const cstate = (_b = (_a = snapshotDeviceResponseInfo === null || snapshotDeviceResponseInfo === void 0 ? void 0 : snapshotDeviceResponseInfo.localCallState) === null || _a === void 0 ? void 0 : _a.compoundCallState) === null || _b === void 0 ? void 0 : _b.localConnectionState;
    ...
    processSnapshotCall(snapshotData) {
      snapshotData.forEach((entry) => {
        var _a, _b, _c, _d;
        if (((_b = (_a = entry.snapshotCallResponseInfo) === null || _a === void 0 ? void 0 : _a.deviceOnCall) === null || _b === void 0 ? void 0 : _b.deviceIdentifier) == this.device.deviceID) {
          if ((_c = entry.snapshotCallResponseInfo) === null || _c === void 0 ? void 0 : _c.localConnectionInfo) {
            this.localConnectionInfo = (_d = entry.snapshotCallResponseInfo) === null || _d === void 0 ? void 0 : _d.localConnectionInfo;
          }
        }
        else {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        let msg = {
          UpdateCall: {
            ...
            correlatorData: options === null || options === void 0 ? void 0 : options.correlatorData,
          }
        };
        if ((options === null || options === void 0 ? void 0 : options.audio) || (options === null || options === void 0 ? void 0 : options.video) || (options === null || options === void 0 ? void 0 : options.display)) {
          msg.UpdateCall.constraints = {
            audio: options === null || options === void 0 ? void 0 : options.audio,
            video: options === null || options === void 0 ? void 0 : options.video,
            display: options === null || options === void 0 ? void 0 : options.display,
          };
        }
        return this.agent.invoke(msg);
      });
    ...
    generateDigits(digits, options) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (options === null || options === void 0 ? void 0 : options.toneDuration) {
    ...
    setRemoteStream(stream, track) {
      ...
      if (stream) {
        ...
        if ((track === null || track === void 0 ? void 0 : track.kind) == "audio") {
          track.onmute = (e) => {
    ...
    getTransceiver(kind) {
      ...
      let transceiver = (_a = this.pc) === null || _a === void 0 ? void 0 : _a.getTransceivers().find(t => { var _a, _b; return ((_b = (_a = t === null || t === void 0 ? void 0 : t.sender) === null || _a === void 0 ? void 0 : _a.track) === null || _b === void 0 ? void 0 : _b.kind) == kind; });
      if (!transceiver) {
        // if there is no sender-track yet, let's try the receiver
        transceiver = (_b = this.pc) === null || _b === void 0 ? void 0 : _b.getTransceivers().find(t => { var _a, _b; return ((_b = (_a = t.receiver) === null || _a === void 0 ? void 0 : _a.track) === null || _b === void 0 ? void 0 : _b.kind) == kind; });
      }
      return transceiver;
    }
    // internal, used by agent
    processGenerateDigits(tones, duration, interToneGap) {
      ...
      if (!this.localDtmfSender && this.localTracks.audio) {
        ...
        this.localDtmfSender = (_a = audioTransceiver === null || audioTransceiver === void 0 ? void 0 : audioTransceiver.sender) === null || _a === void 0 ? void 0 : _a.dtmf;
        if (!this.localDtmfSender) {
          this.agent.debug("creating new DTMF sender");
          // fallback to deprecated createDTMFSender
          this.localDtmfSender = this.pc.createDTMFSEnder(this.localTracks.audio);
        }
      }
      if (this.localDtmfSender) {
        this.localDtmfSender.ontonechange = (event) => this.agent.debug("ontonechange", event);
    ...
    processRtcEvent(content) {
      return __awaiter(this, void 0, void 0, function* () {
        try {
          let remoteDescription = content === null || content === void 0 ? void 0 : content.remoteDescription;
          if ((remoteDescription === null || remoteDescription === void 0 ? void 0 : remoteDescription.type) == "close") {
            this.deletePeerConnection();
            return;
          }
          if (!this.pc) {
            if (content === null || content === void 0 ? void 0 : content.candidatePolicy) {
              this.candidatePolicy = content.candidatePolicy;
            }
            this.pc = this.createPeerConnection(content === null || content === void 0 ? void 0 : content.configuration);
          }
          // first ensure we have the desired streams and tracks
          if (content === null || content === void 0 ? void 0 : content.constraints) {
            let userMedia = {};
            let newTracks = {};
            ...
            if (userMedia.audio) {
              try {
                const stream = yield this.agent.getUserMedia(this, { audio: userMedia.audio });
            ...
            if (userMedia.display) {
              ...
              try {
                ...
                const stream = yield this.agent.getDisplayMedia(this, { audio: false, video: true });
                this.localStream = this.localStream || stream;
            ...
            if (userMedia.video) {
              try {
                const stream = yield this.agent.getUserMedia(this, { video: userMedia.video });
                this.localStream = this.localStream || stream;
    ...
    createPeerConnection(configuration) {
      ...
      pc.addEventListener('negotiationneeded', (_event) => __awaiter(this, void 0, void 0, function* () {
    ...
    deletePeerConnection() {
      ...
      if (this.pc) {
        ...
        if (this.pc.getSenders) {
          ...
          for (let media in this.localTracks) {
            (_a = this.localTracks[media]) === null || _a === void 0 ? void 0 : _a.stop();
          }
        }
        this.pc.close();
        for (let media in this.localTracks) {
    ...
    sendLocalDescription(candidates = undefined) {
      ...
      const sdp = {
        "type": (_a = this.pc.localDescription) === null || _a === void 0 ? void 0 : _a.type,
        "sdp": (_b = this.pc.localDescription) === null || _b === void 0 ? void 0 : _b.sdp
      };
      this.negotiationNeeded = false;
      this.agent.send({
        RtcMessage: {
    ...
    debugTracks(text) {
      ...
      (_a = this.pc) === null || _a === void 0 ? void 0 : _a.getTransceivers().forEach(t => {
        var _a, _b, _c, _d;
        this.agent.debug("  media", ((_b = (_a = t.sender) === null || _a === void 0 ? void 0 : _a.track) === null || _b === void 0 ? void 0 : _b.kind) || ((_d = (_c = t.receiver) === null || _c === void 0 ? void 0 : _c.track) === null || _d === void 0 ? void 0 : _d.kind));
  ...
  class Device {
    ...
    makeCall(dest, options) {
      var _a;
      return __awaiter(this, void 0, void 0, function* () {
        if ((options === null || options === void 0 ? void 0 : options.autoOriginate) === true) {
          options.autoOriginate = "doNotPrompt";
        }
        let msg = {
          MakeCall: {
            callingDevice: this.deviceID,
            autoOriginate: options === null || options === void 0 ? void 0 : options.autoOriginate,
            subjectOfCall: options === null || options === void 0 ? void 0 : options.subjectOfCall,
            correlatorData: options === null || options === void 0 ? void 0 : options.correlatorData,
          }
        };
        if ((options === null || options === void 0 ? void 0 : options.audio) || (options === null || options === void 0 ? void 0 : options.video)) {
        ...
        if (typeof dest === "string") {
          ...
          msg.MakeCall.destinationCall = {
            callID: dest.callID,
            deviceID: (_a = dest.device) === null || _a === void 0 ? void 0 : _a.deviceID
          };
        }
        if (options === null || options === void 0 ? void 0 : options.callingNumber) {
    ...
    snapshotDevice() {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((_b = (_a = response.crossRefIDorSnapshotData) === null || _a === void 0 ? void 0 : _a.snapshotData) === null || _b === void 0 ? void 0 : _b.length) {
          response.crossRefIDorSnapshotData.snapshotData.forEach((entry) => {
            var _a, _b;
            const callID = (_b = (_a = entry.snapshotDeviceResponseInfo) === null || _a === void 0 ? void 0 : _a.connectionIdentifier) === null || _b === void 0 ? void 0 : _b.callID;
            if (callID) {
              let call = this.getCall(callID, true);
              call === null || call === void 0 ? void 0 : call.processSnapshotDevice(entry.snapshotDeviceResponseInfo);
            }
          });
        }
        return response;
    ...
    snapshotCall(callID) {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((_b = (_a = response.crossRefIDorSnapshotData) === null || _a === void 0 ? void 0 : _a.snapshotData) === null || _b === void 0 ? void 0 : _b.length) {
          ...
          call === null || call === void 0 ? void 0 : call.processSnapshotCall(response.crossRefIDorSnapshotData.snapshotData);
          response.call = call;
        }
        return response;
      });
    }
    joinCall(activeCall, joiningDevice, options = {}) {
      return __awaiter(this, void 0, void 0, function* () {
    ...
    setPresenceState(options) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (options === null || options === void 0 ? void 0 : options.requestedPresenceState) {
          msg.SetPresenceState.requestedPresenceState = options.requestedPresenceState;
        }
        if (options === null || options === void 0 ? void 0 : options.namedPresenceState) {
    ...
    updateVoicemail(id, options) {
      return __awaiter(this, void 0, void 0, function* () {
        return this.agent.invoke({
          UpdateVoicemail: Object.assign({ device: this.deviceID, id }, options)
        });
      });
    }
    ...
    processActivity(content) {
      const options = Object.assign({ name: "ActivityEvent", device: this }, content);
  ...
  class Agent {
    constructor() {
      ...
      this.RTCSessionDescription = (_a = Agent.window) === null || _a === void 0 ? void 0 : _a.RTCSessionDescription;
      this.RTCPeerConnection = (_b = Agent.window) === null || _b === void 0 ? void 0 : _b.RTCPeerConnection;
      this.mediaDevices = (_d = (_c = Agent.window) === null || _c === void 0 ? void 0 : _c.navigator) === null || _d === void 0 ? void 0 : _d.mediaDevices;
      this.MediaStream = (_e = Agent.window) === null || _e === void 0 ? void 0 : _e.MediaStream;
      // per default take the same url as the library was loaded from
      this.url = Agent.scriptSrc;
      if (!((_f = this.url) === null || _f === void 0 ? void 0 : _f.startsWith("http")) && ((_g = Agent.window) === null || _g === void 0 ? void 0 : _g.location)) {
        if ((_h = this.url) === null || _h === void 0 ? void 0 : _h.startsWith("/")) {
    ...
    urlParam(name) {
      var _a;
      return new URL((_a = Agent.window) === null || _a === void 0 ? void 0 : _a.location.href).searchParams.get(name);
    }
    getDevice(deviceID) {
      // map "pbx."" domains to "ou." 
      deviceID = deviceID === null || deviceID === void 0 ? void 0 : deviceID.replace(/(.*)@pbx\.(\d+)$/, "$1@ou.$2");
    ...
    processMessage(message) {
      ...
      switch (name) {
        ...
        case 'ServiceInitiatedEvent':
          ...
          call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          break;
        case 'FailedEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.failedConnection.callID, true);
          call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          break;
        case 'ConnectionClearedEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.droppedConnection.callID, true);
          call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          break;
        case 'OriginatedEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.originatedConnection.callID, true);
          call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          break;
        case 'DeliveredEvent':
        case 'DivertedEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.connection.callID, true);
          call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          break;
        case 'EstablishedEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.establishedConnection.callID, true);
          call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          break;
        case 'HeldEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.heldConnection.callID, true);
          call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          break;
        case 'RetrievedEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.retrievedConnection.callID, true);
          call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          break;
        case 'TransferedEvent': // ecma style...
        case 'TransferredEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.primaryOldCall.callID, true);
          call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          if (content.localConnectionInfo == "null") {
            // secondary old call is gone as well
            call = device.getCall((_a = content.secondaryOldCall) === null || _a === void 0 ? void 0 : _a.callID);
            call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          }
          break;
        case 'ConferencedEvent':
        ...
        case 'DtmfDetectedEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.overConnection.callID, true);
          call === null || call === void 0 ? void 0 : call.processEvent(name, content);
          break;
        case 'StopEvent':
          device === null || device === void 0 ? void 0 : device.notify("call", {
        ...
        case 'DoNotDisturbEvent':
          device === null || device === void 0 ? void 0 : device.processDoNotDisturb(content);
          break;
        case 'ForwardEvent':
          device === null || device === void 0 ? void 0 : device.processForward(content);
          break;
        // Proprietary events
        case 'RtcEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.connection.callID, true);
          if (this.processRtcEvents) {
            call === null || call === void 0 ? void 0 : call.processRtcEvent(content);
          }
          break;
        case 'GenerateDigitsEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall(content.connectionToSendDigits.callID, true);
          call === null || call === void 0 ? void 0 : call.processGenerateDigits(content.charactersToSend, content.toneDuration);
          break;
        case 'MessageSummaryEvent':
          device === null || device === void 0 ? void 0 : device.processMessageSummary(content);
          break;
        case 'ActivityEvent':
          device === null || device === void 0 ? void 0 : device.processActivity(content);
          break;
        case 'ConferenceUpdateEvent':
          call = device === null || device === void 0 ? void 0 : device.getCall((_b = content.connection) === null || _b === void 0 ? void 0 : _b.callID, false);
          if (call === null || call === void 0 ? void 0 : call.pc) {
            ...
            console.log("Ignore ConferenceUpdateEvent, there's no webRTC connection to update");
          }
          break;
        case 'ConferenceStream':
          call = device === null || device === void 0 ? void 0 : device.getCall((_c = content.connection) === null || _c === void 0 ? void 0 : _c.callID, false);
          if (call === null || call === void 0 ? void 0 : call.pc) {
            // ignore the ConferenceUpdateEvent if we have no peer webRTC connection 
            // in that case we just passively observe the conference, but we aren't involved in the media
            ...
            console.log("Ignore ConferenceStream, there's no webRTC connection to update");
          }
          break;
        // events outside of a monitor
        case 'PresenceStateEvent':
          device = this.devices.find(dev => dev.deviceID == content.device);
          device === null || device === void 0 ? void 0 : device.processPresenceState(content);
          break;
        case 'ApplicationSessionTerminated':
          this.processApplicationSessionTerminated((_d = content === null || content === void 0 ? void 0 : content.sessionTermReason) === null || _d === void 0 ? void 0 : _d.definedTermReason);
          break;
        case 'CSTAErrorCode':
          invocation === null || invocation === void 0 ? void 0 : invocation.reject(content);
          break;
        default:
          if (invocation) {
      ...
      if (invocation) {
        ...
        this.notify("event", {
          deviceID: device === null || device === void 0 ? void 0 : device.deviceID,
          monitorCrossRefID: content === null || content === void 0 ? void 0 : content.monitorCrossRefID,
    ...
    startApplicationSession(options = { token: true }) {
      ...
      if (options.cookie) {
        ...
        this.token = (_d = (_c = (_b = (_a = Agent.window) === null || _a === void 0 ? void 0 : _a.document) === null || _b === void 0 ? void 0 : _b.cookie) === null || _c === void 0 ? void 0 : _c.match(re)) === null || _d === void 0 ? void 0 : _d[1];
      }
      if (!((_e = Agent.window) === null || _e === void 0 ? void 0 : _e.TextEncoder) || !((_h = (_g = (_f = Agent.window) === null || _f === void 0 ? void 0 : _f.crypto) === null || _g === void 0 ? void 0 : _g.subtle) === null || _h === void 0 ? void 0 : _h.digest)) {
    ...
    sendStartApplicationSession() {
      this.invoke({
        ...
        var _a;
        if (((_a = response.extensions) === null || _a === void 0 ? void 0 : _a.nonce) && this.username && this.password && this.authentication == "digest") {
    ...
    processStartApplicationSessionResponse(response) {
      ...
      if (response.errorCode) {
        ...
        (_a = this.config.deviceList) === null || _a === void 0 ? void 0 : _a.forEach((cfg) => {
    ...
    detectBrowser() {
      ...
      if ((_b = (_a = Agent.window) === null || _a === void 0 ? void 0 : _a.navigator) === null || _b === void 0 ? void 0 : _b.userAgent) {
        let ua = navigator.userAgent;
        let chrome = (_c = /Chrome\/([0-9.]+)/.exec(ua)) === null || _c === void 0 ? void 0 : _c[1];
        let firefox = (_d = /Firefox\/([0-9.]+)/.exec(ua)) === null || _d === void 0 ? void 0 : _d[1];
        let seamonkey = (_e = /Seamonkey\/([0-9.]+)/.exec(ua)) === null || _e === void 0 ? void 0 : _e[1];
        let chromium = (_f = /Chromium\/([0-9.]+)/.exec(ua)) === null || _f === void 0 ? void 0 : _f[1];
        let safari = (_g = /Safari\/([0-9.]+)/.exec(ua)) === null || _g === void 0 ? void 0 : _g[1];
        let opera = (_h = /OPR\/([0-9.]+)/.exec(ua)) === null || _h === void 0 ? void 0 : _h[1];
        if (firefox && !seamonkey)
          return `firefox/${firefox}`;
        if (seamonkey)
          return `seamonkey/${seamonkey}`;
        if (chrome && !chromium)
  ...
  Agent.scriptSrc = (_c = (_b = (_a = Agent.window) === null || _a === void 0 ? void 0 : _a.document) === null || _b === void 0 ? void 0 : _b.currentScript) === null || _c === void 0 ? void 0 : _c.getAttribute("src");
  function newAgent() {
    return new Agent();
  }

  const version = "7.14.4";
  const date = "24-04-04-07:27:17";
